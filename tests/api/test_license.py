...
class TestLicenseValidation:
    ...
    @pytest.mark.asyncio
    async def test_license_status_endpoint(self, client, admin_headers):
    ...
    @pytest.mark.asyncio
    async def test_license_status_requires_admin(self, client, auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_license_contains_expiration(self, client, admin_headers):
...
class TestFeatureGating:
    ...
    @pytest.mark.asyncio
    async def test_sso_feature_gating(self, client, admin_headers):
    ...
    @pytest.mark.asyncio
    async def test_audit_logging_feature(self, client, admin_headers, tenant_id):
    ...
    @pytest.mark.asyncio
    async def test_feature_check_manual(self, client, admin_headers):
...
class TestLicenseTiers:
    ...
    @pytest.mark.asyncio
    async def test_community_tier_features(self, client, admin_headers):
    ...
    @pytest.mark.asyncio
    async def test_professional_tier_features(self, client, admin_headers):
    ...
    @pytest.mark.asyncio
    async def test_enterprise_tier_features(self, client, admin_headers):
...
class TestLicenseLimits:
    ...
    @pytest.mark.asyncio
    async def test_license_limits_returned(self, client, admin_headers):
    ...
    @pytest.mark.asyncio
    async def test_user_count_limit(self, client, admin_headers):
    ...
    @pytest.mark.asyncio
    async def test_team_count_limit(self, client, admin_headers):
...
class TestLicenseKeepalive:
    ...
    @pytest.mark.asyncio
    async def test_keepalive_background_task(self, client):
    ...
    @pytest.mark.asyncio
    async def test_keepalive_includes_usage(self, client):
...
class TestInvalidLicense:
    ...
    @pytest.mark.asyncio
    async def test_invalid_license_format(self, client):
    ...
    @pytest.mark.asyncio
    async def test_expired_license(self, client, admin_headers):

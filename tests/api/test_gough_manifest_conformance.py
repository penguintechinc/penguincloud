...
from app.adapters.nest.manifest import _ACTION_VERBS as _NEST_ACTION_VERBS
from app.adapters.nest.manifest import _ENVELOPE_PATHS as _NEST_ENVELOPE_PATHS
...
_CONFORMANCE_INPUTS: Final[dict[str, _ConformanceInputs]] = {
    ...
    "nest": _ConformanceInputs(
        adapter_cls=NestAdapter,
        action_verbs=dict(_NEST_ACTION_VERBS),
        sensitive_fields=frozenset(),
        envelope_paths=_NEST_ENVELOPE_PATHS,

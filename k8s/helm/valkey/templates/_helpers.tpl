...
{{/*
Secret name (auth password)
*/}}
{{- define "valkey.secretName" -}}
{{- printf "%s-auth" (include "valkey.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
ConfigMap name (valkey.conf + users.acl)
*/}}
{{- define "valkey.configMapName" -}}
{{- printf "%s-config" (include "valkey.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
PVC name
*/}}
{{- define "valkey.pvcName" -}}
{{- printf "%s-data" (include "valkey.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}

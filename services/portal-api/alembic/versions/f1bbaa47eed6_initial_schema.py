...
def upgrade() -> None:
    """Create the initial schema (users, tenants, and related tables)."""
    ...
    op.create_table(
        ...
        sa.Column("max_products", sa.Integer(), server_default=sa.text("5"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("auth_type", sa.String(length=50), server_default="bearer", nullable=False),
...
def downgrade() -> None:
    """Reverse the initial schema, dropping every table it created."""
    # ### commands auto generated by Alembic - please adjust! ###
